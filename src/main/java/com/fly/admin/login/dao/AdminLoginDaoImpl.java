...
public class AdminLoginDaoImpl implements AdminLoginDao {
	...
	public int registCnt(String date) {
		return sqlSession.selectOne(NAME_SPACE + ".registCnt", date);
	}

	@Override
	public int placeCnt(String date) {
		return sqlSession.selectOne(NAME_SPACE + ".placeCnt", date);
	}

	@Override
	public int rentalCnt(String date) {
		return sqlSession.selectOne(NAME_SPACE + ".rentalCnt", date);
	}

	@Override
	public int matchCnt(String date) {
		return sqlSession.selectOne(NAME_SPACE + ".matchCnt", date);
	}

	@Override
	public int supportCnt(String date) {
		return sqlSession.selectOne(NAME_SPACE + ".supportCnt", date);
	}
